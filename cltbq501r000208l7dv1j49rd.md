...
datePublished: Sun Mar 03 2024 16:26:05 GMT+0000 (Coordinated Universal Time)
cuid: cltbq501r000208l7dv1j49rd
slug: 5bya5yr6isa5oml5p625yk5bcb6kof6ieq5yqo5yyw5p6e5bu65bel5l2c5rwb
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1709484280266/d9085386-b2d3-4fce-82be-fd3025349ef1.jpeg
...
答：1、创建一个仓库(目录) 2、通过 npm init 初始化 3、创建一个入口 js 文件 4、package.json 文件增加"bin":"入口文件路径" 5、通过 npm link 命令连接全局 6、命令行运行脚手架命令 7、后面可以通过 npm publish 发布到 npm 仓库
...
```json
{
  ...
  "keywords": ["pages-boilerplate", "boilerplate", "pages", "zce"],
...
> 百度网盘：[https://pan.baidu.com/s/1AyGApMTFEfCeGfQBdykOGg](https://pan.baidu.com/s/1AyGApMTFEfCeGfQBdykOGg) 提取码: bw3r
